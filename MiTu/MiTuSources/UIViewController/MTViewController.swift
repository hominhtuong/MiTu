...
extension UIViewController: MFMailComposeViewControllerDelegate {
    public func sendEmail(to: String, body: String, subject: String? = nil) {
...
extension UIViewController: UNUserNotificationCenterDelegate {
    public func requestNotification(title: String, subtitle: String, body: String, timeInterval: TimeInterval, repeats: Bool, requestIdentifier: String = UUID().uuidString, removeOldNotifications: Bool = false, completionHandler: ((Error?, String?) -> Void)? = nil) {
